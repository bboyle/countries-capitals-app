(function( window, THREE ) {
	...
	function init() {
		var domInsert = document.querySelector( '.loading' );

		var w = domInsert.clientWidth;
		var h = Math.min( domInsert.clientHeight / 2, w );
		...
		domInsert.insertBefore( renderer.domElement, domInsert.firstChild );
